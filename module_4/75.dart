    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ListTile(
            onTap: () {
              ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("${flutterLifecycle[index]}",style: TextStyle(fontSize: 40),selectionColor: Colors.amber,), backgroundColor: Colors.black,));
            },
            title: Text("${flutterLifecycle[index]}",style: TextStyle(fontSize: 30),),
          );
        },
      )
    );
